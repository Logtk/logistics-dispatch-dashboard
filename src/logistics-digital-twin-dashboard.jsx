    ...
    <div className="min-h-screen bg-slate-900 text-slate-100 p-4 md:p-8 font-sans">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <footer className="text-[11px] text-slate-500 pb-4">
          ※ 本ダッシュボードの納品先・手配実績・金額はすべて架空のモックデータです。実在の企業・取引・金額とは一切関係ありません。走行距離はGPS実測ではなく、手配実績からの標準巡回ルート擬似計算値。ルート最適化は同日・同一エリアの名寄せ（混載相積み）による▲18〜30%削減を仮定。曜日集約は週2回上限・車格アップ係数1.2を適用。
        </footer>
      </div>
    </div>
  );
